...
//######### DROP TABLES FIRST
mysql_query("DROP TABLE IF EXISTS se_ratings");
mysql_query("DROP TABLE IF EXISTS se_actions");
mysql_query("DROP TABLE IF EXISTS se_actiontypes");
mysql_query("DROP TABLE IF EXISTS se_admins");
mysql_query("DROP TABLE IF EXISTS se_ads");
mysql_query("DROP TABLE IF EXISTS se_announcements");
mysql_query("DROP TABLE IF EXISTS se_fields");
mysql_query("DROP TABLE IF EXISTS se_friendexplains");
mysql_query("DROP TABLE IF EXISTS se_friends");
mysql_query("DROP TABLE IF EXISTS se_invites");
mysql_query("DROP TABLE IF EXISTS se_levels");
mysql_query("DROP TABLE IF EXISTS se_logins");
mysql_query("DROP TABLE IF EXISTS se_plugins");
mysql_query("DROP TABLE IF EXISTS se_pms");
mysql_query("DROP TABLE IF EXISTS se_profilecomments");
mysql_query("DROP TABLE IF EXISTS se_profiles");
mysql_query("DROP TABLE IF EXISTS se_profilestyles");
mysql_query("DROP TABLE IF EXISTS se_reports");
mysql_query("DROP TABLE IF EXISTS se_settings");
mysql_query("DROP TABLE IF EXISTS se_statrefs");
mysql_query("DROP TABLE IF EXISTS se_stats");
mysql_query("DROP TABLE IF EXISTS se_subnets");
mysql_query("DROP TABLE IF EXISTS se_tabs");
mysql_query("DROP TABLE IF EXISTS se_urls");
mysql_query("DROP TABLE IF EXISTS se_users");
mysql_query("DROP TABLE IF EXISTS se_usersettings");
...
`used_ips` longtext,
PRIMARY KEY (`id`)
)") or die("Create: se_ratings<br>Error: ".mysql_error());
...
)") or die("Create: se_actions<br>Error: ".mysql_error());
...
)") or die("Create: se_actiontypes<br>Error: ".mysql_error());
...
)") or die("Create: se_admins<br>Error: ".mysql_error());

//######### INSERT DEFAULTS INTO se_admins
mysql_query("INSERT INTO `se_admins` (`admin_username`, `admin_password`, `admin_name`, `admin_email`) VALUES ('admin', '$admin_password', 'Administrator', 'email@domain.com')") or die("Insert: se_admins<br>Error: ".mysql_error());
...
mysql_query("CREATE TABLE `se_ads` (
  ...
  PRIMARY KEY  (`ad_id`)
)") or die("Create: se_ads<br>Error: ".mysql_error());
...
)") or die("Create: se_announcements<br>Error: ".mysql_error());
...
//######### CREATE se_fields
mysql_query("CREATE TABLE `se_fields` (
...
)") or die("Create: se_fields<br>Error: ".mysql_error());

//######### INSERT DEFAULTS INTO se_fields
mysql_query("INSERT INTO `se_fields` (`field_id`, `field_tab_id`, `field_order`, `field_dependency`, `field_title`, `field_desc`, `field_error`, `field_type`, `field_signup`, `field_style`, `field_maxlength`, `field_link`, `field_options`, `field_browsable`, `field_required`, `field_regex`, `field_birthday`, `field_html`) VALUES 
...
(9, 1, 2, 0, 'Birthday', '', '', 5, 1, '', 50, '', '', 2, 0, '', 1, '')") or die("Insert: se_fields<br>Error: ".mysql_error());
...
)") or die("Create: se_friendexplains<br>Error: ".mysql_error());
...
)") or die("Create: se_friends<br>Error: ".mysql_error());
...
)") or die("Create: se_invites<br>Error: ".mysql_error());
...
)") or die("Create: se_levels<br>Error: ".mysql_error());

//######### INSERT DEFAULTS INTO se_levels
mysql_query("INSERT INTO `se_levels` (`level_name`, `level_desc`, `level_default`, `level_signup`, `level_message_allow`, `level_message_inbox`, `level_message_outbox`, `level_profile_style`, `level_profile_block`, `level_profile_search`, `level_profile_privacy`, `level_profile_comments`, `level_profile_status`, `level_photo_allow`, `level_photo_width`, `level_photo_height`, `level_photo_exts`) VALUES ('Default Level', '', 1, 0, 1, 100, 50, 1, 1, 1, '012345', '0123456', 1, 1, 200, 200, 'jpg,jpeg,gif,png')") or die("Insert: se_levels<br>Error: ".mysql_error());
...
)") or die("Create: se_logins<br>Error: ".mysql_error());
...
)") or die("Create: se_plugins<br>Error: ".mysql_error());
...
)") or die("Create: se_pms<br>Error: ".mysql_error());
...
)") or die("Create: se_profilecomments<br>Error: ".mysql_error());
...
//######### CREATE se_profiles
mysql_query("CREATE TABLE `se_profiles` (
...
)") or die("Create: se_profiles<br>Error: ".mysql_error());
...
)") or die("Create: se_profilestyles<br>Error: ".mysql_error());
...
)") or die("Create: se_reports<br>Error: ".mysql_error());
...
)") or die("Create: se_statrefs<br>Error: ".mysql_error());
...
mysql_query("CREATE TABLE `se_stats` (
  ...
  PRIMARY KEY  (`stat_id`)
)") or die("Create: se_stats<br>Error: ".mysql_error());
...
)") or die("Create: se_subnets<br>Error: ".mysql_error());
...
//######### CREATE se_tabs
mysql_query("CREATE TABLE `se_tabs` (
  `tab_id` int(9) NOT NULL auto_increment,
  `tab_name` varchar(50) NOT NULL default '',
  `tab_order` int(2) NOT NULL default '0',
  PRIMARY KEY  (`tab_id`)
)") or die("Create: se_tabs<br>Error: ".mysql_error());

//######### INSERT DEFAULTS INTO se_tabs
mysql_query("INSERT INTO `se_tabs` (`tab_id`, `tab_name`, `tab_order`) VALUES 
('1', 'Personal Information', 1),
('2', 'Contact Information', 2)") or die("Insert: se_tabs<br>Error: ".mysql_error());
...
mysql_query("CREATE TABLE `se_urls` (
  ...
  PRIMARY KEY  (`url_id`)
)") or die("Create: se_urls<br>Error: ".mysql_error());
...
)") or die("Create: se_users<br>Error: ".mysql_error());
...
)") or die("Create: se_usersettings<br>Error: ".mysql_error());
