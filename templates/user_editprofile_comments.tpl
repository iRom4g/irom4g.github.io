{include file='header.tpl'}
  ...
  <div id="wrapHI">
   <div id="header">
    <h1>{$user_editprofile_comments6}</h1>
   </div>
  </div>
  </div>
 ...
 <div class="clearFix tBar">
    ...
    {/section}
   {if $user->level_info.level_photo_allow != 0}<li><a href="user_editprofile_photo.php" style="width:6.2em">{$user_editprofile_comments2}</a></li>{/if}
   {if $user->level_info.level_profile_status != 0}<li><a href="user_editprofile_status.php" style="width:6.2em">{$user_editprofile_comments1}</a></li>{/if}
    <li class="activeLink"><a href="user_editprofile_comments.php" style="width:8.2em">{$user_editprofile_comments4}</a></li>
    <li><a href="user_editprofile_settings.php" style="width:10.2em">{$user_editprofile_comments5}</a></li>
     </ul>
    </div>
