...
<div class="mailbox">
    ...
    <div class="clearFix tBar">
     <ul class="tabs">
      <li ><a href="user_messages.php" style="width:7em">{$user_messages_outbox1}</a></li>
      <li class="activeLink"><a href="user_messages_outbox.php" style="width:12em">{$user_messages_outbox2}</a></li>
      <li ><a href="user_messages_settings.php" style="width:11em">{$user_messages_outbox19}</a></li>
     </ul>
    </div>
