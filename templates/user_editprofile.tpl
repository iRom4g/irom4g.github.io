{include file='header.tpl'}
  ...
  <div id="wrap1">
   <div id="content">
    ...
    {/section}
   {if $user->level_info.level_photo_allow != 0}<li><a href="user_editprofile_photo.php" style="width:6.2em">{$user_editprofile7}</a></li>{/if}
   {if $user->level_info.level_profile_status != 0}<li><a href="user_editprofile_status.php" style="width:6.2em">{$user_editprofile6}</a></li>{/if}
    <li><a href="user_editprofile_comments.php" style="width:8.2em">{$user_editprofile9}</a></li>
    <li><a href="user_editprofile_settings.php" style="width:10.2em">{$user_editprofile10}</a></li>
     </ul>
    </div>
