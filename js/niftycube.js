...
var corners = {
  r1:{margin: "0 3px",borderWidth: "0 2px"},
  r2:{margin:"0 2px"},
  r3:{margin:"0 1px"},
  r4:{height: "2px"},
  rb1:{margin: "0 8px",borderWidth:"0 2px"},
  rb2:{margin: "0 6px",borderWidth:"0 2px"},
  rb3:{margin: "0 5px"},
  rb4:{margin: "0 4px"},
  rb5:{margin: "0 3px"},
  rb6:{margin: "0 2px"},
  ...
  rs1:{margin: "0 1px"},
  /*transparent inside*/
  t1:{borderWidth: "0 5px"},
  t2:{borderWidth: "0 3px"},
  t3:{borderWidth: "0 2px"},
  t4:{height: "2px"},
  tb1:{borderWidth: "0 10px"},
  tb2:{borderWidth: "0 8px"},
  tb3:{borderWidth: "0 6px"},
  tb4:{borderWidth: "0 5px"},
  tb5:{borderWidth: "0 4px"},
  tb6:{borderWidth: "0 3px"},
  tb7:{borderWidth: "0 2px",height:"2px"},
  tb8:{borderWidth: "0 1px",height:"2px"},
  ts1:{borderWidth: "0 2px"}
};
...
function Nifty(selector,options)
{
	...
	var rounded = function(selector,options){
		...
		if(options!="")
		{
			var arr = [["left","tl bl"],["right","tr br"],["top","tr tl"],["bottom","br bl"],["transparent","alias"]];
  ...
  var addTopBottom = function(el,side,options,type){
    ...
    setStyle(d, {marginLeft:"-"+getPadding(el,"Left")+"px"});
    setStyle(d, {marginRight:"-"+getPadding(el,"Right")+"px"});
  ...
  var createStrip = function(index,side,btype){
    var x=setStyle(document.createElement("b"), {display:"block",height:"1px",lineHeight:"1px",fontSize: "1px",
                                         overflow:"hidden",borderStyle:"solid",borderWidth:"0 1px"});
    setStyle(x, corners[btype+index]);
    if(side=="left")
    {
      setStyle(x, {borderRightWidth:"0",marginRight:"0"});
    }
    else if(side=="right")
    {
      setStyle(x, {borderLeftWidth:"0",marginLeft:"0"});
    }
    return(x);
  }
  ...
  var sameHeight = function(selector,maxh){
    var i,v=$A(selector.split(",")),t,j,els=[],gap;
    each(v, function(item){
    	each($$(item), function(el){
			...
			if(gap>0)
			{
			  t=setStyle(document.createElement("b"), {height:gap+"px",display:"block"});
			  nc=el.lastChild;
