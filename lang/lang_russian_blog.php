...
$header_blog[1] = "Блог";
$header_blog[2] = "Записи блога";
$header_blog[3] = "все записи";
...
switch ($page) {
  ...
  case "admin_blog":
	$admin_blog[1] = "Общие настройки блога";
  ...
  case "admin_levels_blogsettings":
	...
	$admin_levels_blogsettings[17] = "Категории записей в блоге";
	$admin_levels_blogsettings[18] = "Если Вы хотите разрешить пользователям разделять по категориям их записи в блогах, создайте категории ниже. Эта функция очень полезна для упорядочения всех записей в блогах всеми пользователями, но если у Вас нет категорий, то не будет предоставлена возможность присваивать категории в блоге.";
	$admin_levels_blogsettings[19] = "Добавить категорию";
	...
	$admin_levels_blogsettings[28] = "<b>Комментарии к блогу</b><br>Пользователи могут выбрать любой из вариантов ниже, когда они решают, кто может отправлять комментарии на их записи в блоге. Если Вы не измените опции, то каждый будет иметь возможность оставлять комментарии.";
  ...
  case "blog":
	...
	$blog[7] = "Первая Страница";
	$blog[8] = "просмотр записи";
	$blog[9] = "из";
	$blog[10] = "просмотр записей";
	$blog[11] = "Следующая Страница";
	$blog[12] = "Произошла ошибка";
	$blog[13] = "Вы должны войти в систему, что бы просмотреть эту страницу. <a href='login.php'>Нажмите здесь</a> чтобы войти.";
	$blog[14] = "Вернуться";
	break;

  case "blog_category":
	$blog_category[1] = "Все записи в блоге";
	$blog_category[2] = "Без названия";
	$blog_category[3] = "комментарии";
	$blog_category[4] = "написать комментарий";

	$blog_category[6] = "Первая страница";
	$blog_category[7] = "просмотр записи";
	$blog_category[8] = "из";
  ...
  case "blog_entry":
	...
	$blog_entry[22] = "Вернуться";
	$blog_entry[23] = "Вы должны войти в систему, что бы просмотреть эту страницу. <a href='login.php'>Нажмите здесь</a> чтобы войти.";
	$blog_entry[24] = "Назад к блогу ";
	$blog_entry[25] = " Блог";
  ...
  case "user_blog":
	...
	$user_blog[2] = "Настройки блога";
	$user_blog[3] = "Мои записи";
	$user_blog[4] = "Ваш блог - это место, где Вы можете поделиться своими личными мыслями и новостями с другими людьми. Воспользуйтесь этой страницей для создания новой записи, поиска, редактирования и управления существующими записями блога.";
	$user_blog[5] = "Создать новую запись";
	$user_blog[6] = "Поиск записей";
	$user_blog[7] = "Ссылка на мой блог:";
	$user_blog[8] = "Поиск записей в:";
	$user_blog[9] = "Первая страница";
	$user_blog[10] = "просмотр записи";
	$user_blog[11] = "из";
  ...
  case "user_blog_comments":
	...
	$user_blog_comments[2] = "Настройки блога";
	$user_blog_comments[3] = "Комментарии в блоге";
	...
	$user_blog_comments[7] = "Первая страница";
	$user_blog_comments[8] = "комметарий";
	$user_blog_comments[9] = "из";
	$user_blog_comments[10] = "сомметарии";
  ...
  case "user_blog_deleteentry":
	...
	$user_blog_deleteentry[2] = "Настройки блога";
	$user_blog_deleteentry[3] = "Удалить запись в блоге?";
	$user_blog_deleteentry[4] = "Вы действительно хотите удалить эту запись? Запись будет удалена из блога безвозвратно!";
  ...
  case "user_blog_editentry":
	...
	$user_blog_editentry[2] = "Настройки блога";
	...
	$user_blog_editentry[10] = "Включить эту запись блога в результаты поиска?";
	$user_blog_editentry[11] = "Да, включить эту запись блога в результаты поиска.";
	$user_blog_editentry[12] = "Нет не включать эту запись блога в результаты поиска.";
  ...
  case "user_blog_newentry":
	...
	$user_blog_newentry[2] = "Настройки блога";
	$user_blog_newentry[3] = "Новая запись";
	$user_blog_newentry[4] = "Напишите новую запись ниже, а затем выберите \"Отправить\" для публикации в блоге.";
	...
	$user_blog_newentry[9] = "Включить эту запись блога в результаты поиска?";
	$user_blog_newentry[10] = "Да, включить эту запись блога в результаты поиска.";
	$user_blog_newentry[11] = "Нет не включать эту запись блога в результаты поиска.";
  ...
  case "user_blog_settings":
	...
	$user_blog_settings[3] = "Настройки блога";
	$user_blog_settings[4] = "Стиль блога";
	$user_blog_settings[5] = "Вы можете изменить цвет, шрифт и стиль Вашего блога, добавив свой CSS-код. Содержимое в поле должно быть заключено в теги &lt;style&gt;.";
	$user_blog_settings[6] = "Сохранить изменения";
	$user_blog_settings[7] = "Настройки блога";
	$user_blog_settings[8] = "Изменение настроек блога.";
	$user_blog_settings[9] = "Уведомления блога";
	$user_blog_settings[10] = "Вы хотите получать уведомления по электронной почте, когда кто-то публикует комментарий в блоге?";
	$user_blog_settings[11] = "Да, уведомить меня, когда кто-то написал комментарий в моём блоге.";
	break;
}
