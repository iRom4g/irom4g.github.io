...
$functions_album[2] = "альбомы/медиа";
...
switch ($page) {
  ...
  case "admin_album":
	...
	$admin_album[14] = "Нет, общественность не можете просматривать альбомы.";
	break;
  ...
  case "admin_levels_albumsettings":
	...
	$admin_levels_albumsettings[8] = "Список следующих расширений файлов, которые пользователи могут загрузить. Отдельные расширений файлов разделяются запятыми, например: jpg, gif, jpeg, png, bmp";
  ...
  case "album":
	...
	$album[8] = "Вы должны войти в систему, что бы просмотреть эту страницу. <a href='login.php'>Нажмите здесь</a> чтобы войти.";
	$album[9] = "Первая страница";
  ...
  case "album_file":
	...
	$album_file[10] = "";
	$album_file[11] = "Отправить комментарий";
	...
	$album_file[18] = "Вы должны войти в систему, что бы просмотреть эту страницу. <a href='login.php'>Нажмите здесь</a> чтобы войти.";
  ...
  case "user_album_comments":
	...
	$user_album_comments[7] = "Первая страница";
	$user_album_comments[8] = "комментарий";
	$user_album_comments[9] = "из";
	$user_album_comments[10] = "комментарии";
  ...
  case "user_album_upload":
	$user_album_upload[1] = "был успешно загружен.";
	...
	$user_album_upload[18] = "<br>Вы можете загружать файлы размером до";
