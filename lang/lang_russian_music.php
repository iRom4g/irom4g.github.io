...
switch ($page) {
  ...
  case 'user_music_edit':
	...
	$user_music_edit[14] = 'У Вас нет аудиозаписей';
	break;
  ...
  case 'user_music_upload':
	...
	$user_music_upload[17] = "";

	$user_music_upload[18] = "  <table cellpadding='0' cellspacing='0'>
    <tr>
    <td class='result'><a href=\"#\" onclick=\"javascript:showBasic(); return false;\">Обычный Загрузчик</a></td>
    </tr>
    </table>";
  ...
  case 'user_music_delete':
	$user_music_delete[1] = 'Удалить Песню?';
	$user_music_delete[2] = 'Вы уверены, что хотите удалить эту песню?';
	$user_music_delete[3] = 'Удалить Песню';
	$user_music_delete[4] = 'Отмена';
	$user_music_delete[5] = 'Изменить Музыку';
	$user_music_delete[6] = 'Настройки Музыки';
	break;
