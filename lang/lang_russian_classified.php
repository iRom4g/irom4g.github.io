...
switch ($page) {
  ...
  case "admin_levels_classifiedsettings":
	...
	$admin_levels_classifiedsettings[44] = "Сколько свободного пространства необходимо иметь каждому пользователю, чтобы хранить свои файлы?";
	...
	$admin_levels_classifiedsettings[50] = "(в пикселях, целое число от 1 до 9999)";
	break;
  ...
  case "user_classified":
	...
	$user_classified[25] = "Удалить выбранное";
  ...
  case "user_classified_settings":
	...
	$user_classified_settings[10] = "Вы хотите получать уведомления, когда кто-нибудь оставляет комментарии к Вашим объявлениям?";
