...
case "admin_viewpolls":
  ...
  case "poll":
	...
	$poll[35] = "голосов"; // USED IN JAVASCRIPT, DONT USE SLASHES, QUOTES OR APOSTROPHES
  ...
  case "polls":
	...
	$polls[25] = "или";
	$polls[26] = "Голосовать";
	$polls[27] = "голосов"; // USED IN JAVASCRIPT, DONT USE SLASHES, QUOTES OR APOSTROPHES
  ...
  case "user_poll_edit":
	$user_poll_edit[1] = "Опрос";
	$user_poll_edit[2] = "Комментарии";
	...
	$user_poll_edit[18] = "Вернуться к Моим Опросам";
	break;

  case "user_poll_edit_comments":
	$user_poll_edit_comments[1] = "Опрос";
	$user_poll_edit_comments[2] = "Комментарии";
	$user_poll_edit_comments[4] = "Фотографии";
	$user_poll_edit_comments[5] = "Комментарии";
	$user_poll_edit_comments[6] = "Стиль опроса";
	$user_poll_edit_comments[7] = "Отменить опрос";
	$user_poll_edit_comments[8] = "Вернуться к Моим Опросам";
	$user_poll_edit_comments[9] = "Комментарии к опросу:";
	$user_poll_edit_comments[10] = "Для удаления отметьте комментарий(ии) и нажмите на кнопку \"Удалить Выбранные\".";
	$user_poll_edit_comments[11] = "Последняя страница";
	$user_poll_edit_comments[12] = "комментарий";
	$user_poll_edit_comments[13] = "из";
	$user_poll_edit_comments[14] = "комментариев";
	$user_poll_edit_comments[15] = "Следующая страница";
	$user_poll_edit_comments[16] = "В этом опросе нет комментарий.";
	$user_poll_edit_comments[17] = "Аноним";
	$user_poll_edit_comments[18] = "Удалить Выбранные";
	$user_poll_edit_comments[19] = "\\в"; //THESE CHARACTERS ARE BEING ESCAPED BECAUSE THEY ARE BEING USED IN A DATE FUNCTION
	$user_poll_edit_comments[20] = "отметить все комментарии";
	break;
